...
/**
 * @generated
 *  Flow: CreateResourceShipmentOMSMed Interface: CreateResourceShipmentOMSInt Operation: CreateResourceShipmentOMS Type: request Custom Mediation: Log_OMSReqPayload
 */
public class Custom1516786282194 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		BPMCustomLogger.logInfo("AppS_CreateResourceShipment_OM",
				"CreateResourceShipmentOMSMed", "Request Received from OMS");
