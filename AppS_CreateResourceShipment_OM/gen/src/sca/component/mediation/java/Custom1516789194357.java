...
/**
 * @generated
 *  Flow: CreateResourceShipmentOMSMed Interface: CreateResourceShipmentOMSInt Operation: CreateResourceShipmentOMS Type: request Custom Mediation: Log_TPBS_Error
 */
public class Custom1516789194357 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		BPMCustomLogger.logInfo("AppS_CreateResourceShipment_OM",
				...
				"Logging BS_TimeOut_Error message");
