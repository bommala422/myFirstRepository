...
/**
 * @generated
 *  Flow: CreateResourceShipmentOMSMed Interface: CreateResourceShipmentOMSInt Operation: CreateResourceShipmentOMS Type: request Custom Mediation: Log_TPRequestPayload
 */
public class Custom1516788312561 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		BPMCustomLogger.logInfo("AppS_CreateResourceShipment_OM",
				...
				"Request Sending to TP BS Service");
