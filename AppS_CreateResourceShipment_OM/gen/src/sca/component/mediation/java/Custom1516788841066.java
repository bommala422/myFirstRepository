...
/**
 * @generated
 *  Flow: CreateResourceShipmentOMSMed Interface: CreateResourceShipmentOMSInt Operation: CreateResourceShipmentOMS Type: request Custom Mediation: Log_BS_TimeOutErr
 */
public class Custom1516788841066 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		out.fire(ExceptionHelper.processUndefinedError(smo, out,
				TPConstants.AppS_TIMEOUT_FAIL,
				smo.getString("/context/shared/OrderHeaderKey"))); // propagate the service message object to the primitive that is wired to the 'out' terminal
	}
}
