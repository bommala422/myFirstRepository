...
/**
 * @generated
 *  Flow: FTLWrapperMED Interface: PutMessageFTLWrapper Operation: putMessage Type: request Custom Mediation: Log_FTLWrapper_Error
 */
public class Custom1519483688299 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		try {
			keys.put("CorrelationId_T",
					smo.getString("/context/correlation/correlationId"));
		} catch (Exception e) {
			BPMCustomLogger
		...
		BPMCustomLogger.logInfo("***** FTL Wrapper Error ::" + keys + " "
				+ TPConstants.AS_TIMEOUT_FAIL_TIBCO);
