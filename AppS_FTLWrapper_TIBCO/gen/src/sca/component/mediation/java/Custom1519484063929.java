...
/**
 * @generated
 *  Flow: FTLWrapperMED Interface: PutMessageFTLWrapper Operation: putMessage Type: request Custom Mediation: Log_Map_Failure
 */
public class Custom1519484063929 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		BPMCustomLogger
				.logInfo("***** Mapping failure at Access Service layer *****"
						+ keys + "  " + TPConstants.BOMAP_XSLT_FAIL);
